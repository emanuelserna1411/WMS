...
namespace WMS.Backend.Migrations
{
    ...
    [Migration("20250117152628_CreateSuppliers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Share.Models.Magister.Supplier", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WMS.Share.Models.Security.Form", b =>
                {
                    ...
                    b.Property<long>("FormSubParentId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FormSubParentId", "Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("WMS.Share.Models.Security.FormSubParent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WMS.Share.Models.Security.Form", b =>
                {
                    b.HasOne("WMS.Share.Models.Security.FormSubParent", "FormSubParent")
                        .WithMany("Forms")
                        .HasForeignKey("FormSubParentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FormSubParent");
                });

            modelBuilder.Entity("WMS.Share.Models.Security.FormSubParent", b =>
                {
                    b.HasOne("WMS.Share.Models.Security.FormParent", "FormParent")
                        .WithMany("FormSubParents")
